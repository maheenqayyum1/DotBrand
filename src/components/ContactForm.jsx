        ...
        <div className="flex-none bg-red-900 w-[350px] h-[550px] rounded-md overflow-hidden">
          ...
          <div className="mt-8 ml-4 text-white">
            <div className="flex items-center mb-3">
              <FiPhoneCall className="w-6 h-6 border rounded-full mr-2 p-1" />
              <p>Contact Number: 123-123-1234</p>
            </div>
            <div className="flex items-center mb-3">
              <FaMapMarkerAlt className="w-6 h-6 border rounded-full mr-2 p-1" />
              <p>Location: DotBrand Lahore</p>
            </div>
            <div className="flex items-center mb-3">
              <FiMail className="w-6 h-6 border rounded-full mr-2 p-1" />
              <p>Email: dotbrand@gamil.com</p>
            </div>
            
            <div className="flex space-x-4 mt-14">
            <p>You can also reach us on |</p>
              {/* Social media icons */}
              <a href="https://facebook.com" className="text-yellow-400">
                <FaFacebook className="w-7 h-7 border border-yellow-400 rounded-full p-1" />
              </a>
              <a href="https://twitter.com" className="text-yellow-400">
                <FaTwitter className="w-7 h-7 border border-yellow-400 rounded-full p-1" />
              </a>
              <a href="https://plus.google.com" className="text-yellow-400">
                <IoLogoGoogleplus className="w-7 h-7 border border-yellow-400 rounded-full p-1" />
              </a>
            </div>
          </div>
        </div>
